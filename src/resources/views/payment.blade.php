        ...
        <div class="payment-container">
            ...
            <div class="payment-invoice">
                ...
                <div class="property-invoice-card">
                    <img class="property-invoice-img" src="{{ $property->coverPhoto->url_foto ?? '/images/landing/property.png' }}" alt="{{ $property->nama_properti }}" style="object-position: {{ $property->coverPhoto->position_style ?? 'center 50%' }};">
