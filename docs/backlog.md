...
| Registrasi dan Login | US-11 | As a user, I want daftar atau masuk menggunakan identitas saya seperti nama, e-mail, no.hp, dan password, so that saya dapat mengakses fitur yang ada di sistem | Given pengguna berada di halaman awal, When pengguna menekan tombol “Daftar”, Then sistem menampilkan form registrasi | Must Have |
